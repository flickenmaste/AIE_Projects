...
bool Tutorial12_Shadows::onCreate(int a_argc, char* a_argv[])
{
	...
	GLuint vshader = Utility::loadShader("./shaders/shadows.vert", GL_VERTEX_SHADER);
	GLuint pshader = Utility::loadShader("./shaders/shadows.frag", GL_FRAGMENT_SHADER);
	...
	m_fbx = new FBXFile();
	m_fbx->load("./Models/tanks/antiair_tank.fbx", FBXFile::UNITS_METER);
